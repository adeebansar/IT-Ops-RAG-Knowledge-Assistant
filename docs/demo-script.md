...
1. "This is my IT Operations RAG Knowledge Assistant. It uses sample SOPs, outage notes, ticket logs, asset inventory notes, and policy docs."
...
7. "For safety, this repo uses sample practice data only and excludes `.env`, uploaded private docs, and the local Chroma database from GitHub."
